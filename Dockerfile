...
RUN curl -fsSL https://dl.google.com/linux/linux_signing_key.pub | gpg --dearmor -o /usr/share/keyrings/google-chrome.gpg \
    ...
    && sed -i 's/Exec=\/usr\/bin\/google-chrome-stable %U/Exec=\/usr\/bin\/google-chrome-stable --disable-gpu --disable-software-rasterizer %U/g' /usr/share/applications/google-chrome.desktop \
    && rm -rf /var/lib/apt/lists/*
